...
function datewise_dailypayout(id){

document.getElementById("datewisedailypayout").innerHTML="<img src='http://www.adways.biz/assets/frontarea/images/loading.gif' width='20' height='20' > Loading.......";  
...
var url="datewise_weeklypayout_details";
...
document.getElementById("datewisedailypayout").innerHTML=xmlHttp889.responseText;
