...
function datewise_dailylegcount(id){
	var newurlarray = id.split(' ');
	var id = newurlarray[0]+'_'+newurlarray[1];
	

document.getElementById("datewisedailylegcount").innerHTML="<img src='http://www.adways.biz/assets/frontarea/images/loading.gif' width='20' height='20' > Loading.......";  
...
var url="datewise_dailylegcount_details";
...
document.getElementById("datewisedailylegcount").innerHTML=xmlHttp889.responseText;
