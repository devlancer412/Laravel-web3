        ...
        <div class="panel panel-blue">
          <div class="panel-body">
              ...
              <table width="100%" id="responsiveTable" class="table table-striped table-bordered no-margin">
                <thead>
                  <tr>
                    <th width="9%">Slno</th>
                    <th width="11%"> Date</th>
                    <th width="14%">Total Subscriptions HRC</th>
                    <th width="25%">5% Pool HRC</th>
                    <th width="12%">Eligible Members</th>
                    <th width="12%">Eligible Income</th>
                  </tr>
                </thead>
                <tbody>
                  <?Php		
			...
			$userstatus="Registered user";$activecoupon="";$actvatedddate="";$activecoupon=0;
	     	...
	     	$sqlfrom= "SELECT * FROM globalplan_daily_poolhrc where  c_status='Y' AND  DATE_FORMAT(d_to,'%m/%d/%Y') between '$fromdate' and '$todate'";		
