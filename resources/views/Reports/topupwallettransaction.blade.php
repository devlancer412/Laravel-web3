...
<script src="master/js/toastr.min.js"></script>		
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Topup Wallet Transaction</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-layout mr-2 fs-14"></i>Topup  Wallet Transaction</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Topup Wallet Transaction</a></li>
								</ol>
							</div>
							...
							<div class="col-12">
								...
								<div class="card">
									<div style="justify-content: space-between;" class="card-header">
										<div class="card-title">Topup Wallet Transaction</div>
										...
										<table class="table table-bordered text-nowrap" id="example1">
												<thead>
													...
													<th class="wd-15p border-bottom-0">Sl.No</th>
														...
														<th class="wd-15p border-bottom-0">Transfer HRC</th>
