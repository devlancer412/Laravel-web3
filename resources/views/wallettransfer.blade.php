@include('_header')
	<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Transfer</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-layers mr-2 fs-14"></i>Pages</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Transfer</a></li>
								</ol>
							</div>
									...
									<div class="card-body">
										<form class="form-horizontal">
													...
													<div class="form-group row mb-0">
														...
														<div class="col-md-12">
															<div style="justify-content: space-between;" class="d-flex "><label class=" form-label">Enter HRC Amount </label>
									...
									<div class="card-body">
										<form class="form-horizontal">
													...
													<div class="form-group row mb-0">
														...
														<div class="col-md-12">
															<div class="d-flex bgf"><div>Available Balance</div> <div>27.09966189 HRC</div></div>
															<div style="    justify-content: space-between;
    margin-top: 4px;
    font-size: 12px;
    font-weight: 100;
    padding: 5px 32px;"  class="d-flex"><div>Minimum Amount : 2 HRC</div> <div>Maximum Amount : 10000000 HRC</div></div>
														</div>
													</div>
<div class="form-group row mb-0">
