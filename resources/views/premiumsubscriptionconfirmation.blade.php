						...
						<form class="form-horizontal" id="confirm_form">
							...
							<div class="form-group row ">
								...
								<div class="col-md-12">
									...
									<input value="Premium" type="text" id="sub_package" name="sub_package" readonly>
								</div>
							</div>
							<div class="form-group row ">							
								<div class="col-md-12">
									<label class=" form-label">Subscription Amount</label>
									<input value="" type="text" id="basichrc" name="sub_amount" readonly>
...
label.form-label {
    ...
    $.ajax(
    {
        url:"{{url('premiumsubconfirmation')}}",
        type: "GET",
        dataType : 'json',
        success: function(result)
        {    
            // alert(result);
            $('#basic').val(result.premium);
            $('#basichrc').val(result.premiumhrc);
