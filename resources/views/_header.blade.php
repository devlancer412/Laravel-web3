...
<head>
        ...
        <meta content="Highrich Coin Dashboard" name="description">
        <meta content="Highrich Cryptocurrency" name="author">
        <meta name="keywords" content="hr crypto,Cryptocurrency, best Coin, powerful Coin"/>
        <script src="{{ asset('assets/js/jquery-3.5.1.min.js')}}"></script>

        <title>Hr Crypto</title>
 <link href="{{ asset('assets/plugins/treeview/treeview.css')}}" rel="stylesheet" type="text/css" />
       ...
       <link href="{{ asset('assets/css/sidemenu.css')}}" rel="stylesheet">
        ...
        <link rel="stylesheet" href="{{ asset('assets/plugins/simplebar/css/simplebar.css')}}">
          <link rel="stylesheet" href="{{ asset('assets/plugins/treeview/treeview.css')}}">
        ...
        <link rel="{{ asset('master/css/toastr.min.css')}}">
        </head>
...
<!--     <div class="switcher-wrapper">
            ...
            <div class="page-main">
                <aside class="app-sidebar">
                    <div class="app-sidebar__logo">
                        ...
                        <a class="header-brand" href="dashboardview">
                    ...
                    <div class="app-sidebar__user">
                        <div class="dropdown user-pro-body text-center">
                            <div class="user-pic">
                              <img src="{{ asset('assets/images/widget_icon/atr.png')}}" alt="user-img" class="avatar-xl rounded-circle mb-2">
                                <!--<img src="assets/images/users/2.jpg" alt="user-img" class="avatar-xl rounded-circle mb-1">-->
                            </div>
                            <div class="user-info">
                                <h5 class=" mb-1"><span id="name"></span> <i class="ion-checkmark-circled  text-success fs-12"></i></h5>
                                <span class="text-muted app-sidebar__user-name text-sm"></span>
                            </div>
                        </div>
                        <div class="sidebar-navs">
                            <ul class="nav nav-pills-circle">
                                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Query">
                                    <a class="icon" href="risequery" >
                                        <i class="las la-life-ring header-icons"></i>
                                    </a>
                                </li>
                                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Documentation">
                                    <a class="icon" href="/master/pdf/coin.pdf">
                                        <i class="las  la-file-alt header-icons"></i>
                                    </a>
                                </li>
                                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Share">
                                    <a href="#" class="icon" id="share">
                                        <i class="las la-project-diagram header-icons"></i>
                                    </a>

                                </li>
                                <li class="nav-item" data-placement="top" data-toggle="tooltip" title="Settings">
                                    <a class="icon" href="editprofile">
                    ...
                    <ul class="side-menu app-sidebar3">
                        ...
                        <li class="slide">
                            <a class="side-menu__item"  href="{{url('dashboardview')}}">
                ...
                <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="index.php">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            ...
                            <span class="side-menu__label">Infinity Level</span><i class="angle fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                            <li><a href="referalfriendsview" class="slide-item">My Referrals</a></li>
                            <!-- <li><a href="deposite.php" class="slide-item">My Team</a></li>-->
                            <!--<li><a href="#" class="slide-item">My Team Level Wise</a></li>-->
                            <li><a href="infinitylevel" class="slide-item">Infinity Level Points</a></li>
 ...
 <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="index.php">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            <span class="side-menu__label">Global Club</span><i class="fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                            <li><a href="{{url('globalmember')}}" class="slide-item">Global Club Members</a></li>
                            <li><a href="{{url('globalclub')}}" class="slide-item">Global Club Points</a></li>
                            </ul>
                        </li>
...
<li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="index.php">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27L12 16zm0-11.47L17.74 9 12 13.47 6.26 9 12 4.53z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            <span class="side-menu__label">Royal Referral</span><i class="angle fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                            <li><a href="{{url('royalmember')}}" class="slide-item">Royal Referral Members </a></li>
                            <li><a href="{{url('royalreferal')}}" class="slide-item">Royal Referral Points </a></li>
                   ...
                   <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="index.php">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M19 15v4H5v-4h14m1-2H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zM7 18.5c-.82 0-1.5-.67-1.5-1.5s.68-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM19 5v4H5V5h14m1-2H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zM7 8.5c-.82 0-1.5-.67-1.5-1.5S6.18 5.5 7 5.5s1.5.68 1.5 1.5S7.83 8.5 7 8.5z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            <span class="side-menu__label">Leader Ship Bonus</span><i class="angle fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                            <li><a href="{{url('leadership')}}" class="slide-item">Leader Ship Bonus</a></li>
                            </ul>
                        </li>
                       <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="hrcincomewallet">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            <span class="side-menu__label">Wallet</span><i class="angle fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                              <li><a href="{{url('subscription')}}" class="slide-item">Subscription</a></li>
                            <li><a href="{{url('hrcincomewallet')}}" class="slide-item"> HRC Wallet Transaction</a></li>
                            <li><a href="{{url('topupwallet')}}" class="slide-item"> Topup Wallet Transaction</a></li>
                            </ul>
                        </li


                         <li class="slide">
                            <a class="side-menu__item"  href="{{url('geneology')}}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg>
                            <span class="side-menu__label">Geneology</span><!-- <span class="badge badge-danger side-badge">Hot</span> --></a>
                        </li>
                ...
                <li class="slide">
                            ...
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            <span class="side-menu__label">Settings</span><i class="angle fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                            <li><a href="{{url('profile')}}" class="slide-item">View Profile</a></li>
                            <li><a href="{{url('editprofile')}}" class="slide-item">Edit Profile</a></li>
                            <li><a href="{{url('changepassword')}}" class="slide-item" >Change Password</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="index.php">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                            <path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/><circle cx="12" cy="9" r="2.5"/></svg>
                            <span class="side-menu__label">Query View</span><i class="angle fa fa-angle-double-up"></i></a>
                            <ul class="slide-menu">
                            <li><a href="{{url('risequery')}}" class="slide-item">Rise Query</a></li>
                            <!--<li><a href="queryhistory" class="slide-item">Query History</a></li>-->
                            </ul>
                        </li>
                         ...
                         <li class="slide">
                            <a class="side-menu__item"  href="{{url('deposit')}}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg>
                            <span class="side-menu__label">Deposit</span><!-- <span class="badge badge-danger side-badge">Hot</span> --></a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item"  href="{{url('withdrawview')}}">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg>
                            <span class="side-menu__label">Withdraw</span><!-- <span class="badge badge-danger side-badge">Hot</span> --></a>
                        </li>

                          <li class="slide">
                            <a class="side-menu__item"  href="{{url('myteamm')}}">
                                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5v2h-4V5h4M9 5v6H5V5h4m10 8v6h-4v-6h4M9 17v2H5v-2h4M21 3h-8v6h8V3zM11 3H3v10h8V3zm10 8h-8v10h8V11zm-10 4H3v6h8v-6z"/></svg>
                            ...
                            <li class="slide">
                                    ...
                                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/>
                                    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.88-2.88 7.19-5 9.88C9.92 16.21 7 11.85 7 9z"/></svg>
                                    <span class="side-menu__label">Logout</span><i class="angle fa fa-angle-double-up"></i><!-- <span class="badge badge-danger side-badge">Hot</span> --></a>
                            </li>
                            ...
                            <div class="container-fluid">
                                <div class="d-flex">
                                    ...
                                    <div class="app-sidebar__toggle" data-toggle="sidebar">
                                        <a class="open-toggle" href="index.php">
                                    ...
                                    <div class="d-flex order-lg-2 ml-auto">
                                        <a href="index.php" data-toggle="search" class="nav-link nav-link-lg d-md-none navsearch">
                                            <svg class="header-icon search-icon" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                                                <path d="M0 0h24v24H0V0z" fill="none"/><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
                                            </svg>
                                        </a>
                                        ...
                                        <div class="dropdown profile-dropdown">
                                            <a href="index.php" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                                <span>
                                                    <img src="{{ asset('assets/images/widget_icon/atr.png')}}" alt="img" class="avatar avatar-md brround">
                                                </span>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                                <div class="text-center">
                                                    <a href="index.php" class="dropdown-item text-center user pb-0 font-weight-bold"><span id="username"></span></a>
                                                ...
                                                <a class="dropdown-item d-flex" href="index.php">
