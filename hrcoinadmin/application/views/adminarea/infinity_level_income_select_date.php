      ...
      <div class="row gutter">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <ul class="right-stats" id="mini-nav-right">
            <li><a href="javascript:void(0)" class="btn btn-danger"><span>Select Date for Infinity Level Income Lists</span></a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="panel panel-blue">
          <div class="panel-body">
            <div class="table-responsive">
              <form role="form" name="form" id="form" method="post"  action="<?Php echo base_url() ?>infinity_level_income">
