...
<script src="master/vendors/js/jquery.validate.min.js"></script>
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Infinity Level Points</h4>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#"><i class="fe fe-layout mr-2 fs-14"></i>Infinity Level</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="#">Infinity Level Points</a></li>
								</ol>
							</div>
							...
							<div class="col-12">
								...
								<div class="card">
									<div style="justify-content: space-between;" class="card-header">
										<div class="card-title">Infinity Level Points</div>
									...
									<div class="card-body">
										...
										<table class="table table-bordered text-nowrap" id="infinte-table">
												<thead>
													<tr>
														...
														<th class="wd-15p border-bottom-0">Subscribed Userid</th>
														<th class="wd-15p border-bottom-0">Level</th>
														<th class="wd-15p border-bottom-0">Subscribed HRC</th>
                                                        <th class="wd-15p border-bottom-0">Percentage</th>
														<th class="wd-15p border-bottom-0">Total Points</th>
														<th class="wd-15p border-bottom-0"> Topup Wallet</th>
                                                        <th class="wd-15p border-bottom-0"> HRC Wallet</th>
        ...
        $.ajax(
         {
            ...
            url: "{{ url('infinity_level_dataload') }}",
                ...
                if(check==true){
                    ...
                    { 
                      ...
                      var ymd  = date.getDate() + '-' + (date.getMonth() + 1) + '-' + date.getFullYear();
                        ...
                        output += '<td>' + data[count].n_level + '</td>';
                        output += '<td>' + data[count].n_subscribed_hrc + ' ' + 'hrc'+ '</td>';
                        output += '<td>' + data[count].n_percentage + '% '+'</td>';
                        output += '<td>' + data[count].n_total_income + '</td>';
                        output += '<td>' + data[count].n_topup_wallet + '</td>';
    
                        output += '<td>' + data[count].n_hrc_wallet + '</td></tr>';
